...
const cfn_changePassword = httpsCallable(functions, 'cfn_updateUser');
export async function changePassword(uid, update){
    await cfn_changePassword({uid, update});
}
...
//Rahul Kotturi - Searching Product
