...
export const formChangePassword = document.getElementById('form-change');
...
export const modalChangePassword = new bootstrap.Modal(document.getElementById('modal-change'),{backdrop:'static'});
