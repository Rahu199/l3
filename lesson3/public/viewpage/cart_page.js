...
export function addEventListeners() {
    MENU.ShoppingCart.addEventListener('click', async () => {
...
export async function cart_page() {
  ...
  <tbody>
    ...
    <button id="button-continue-shopping" class="btn btn-outline-success">Continue Shopping</button>
    `;
    ...
    checkoutButton.addEventListener('click', async () => {
        ...
        try{
            ...
            //save to firebase(await) ==>part 2 of lesson3
